...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-01-2016 a las 15:48:30
...
('INGENIERIA de SOFT', 'Roger Pressman', 'MCGrawHill', 440, 2011, 650),
('Ingenieria de Software', 'Roger Pressman', 'MCGrawHill', 440, 2011, 650);
...
(5, 'Luisa Maria', 'Suarez Hernandez', 32, 7571063990),
(6, 'Ana', 'Lopez Diaz', 26, 7571009089),
(11, 'Gerardo', 'Suarez Lopez', 28, 7571002869);
